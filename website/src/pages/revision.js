...
const DAY_LABELS = {
  day1: { label: "Yesterday", desc: "1 day ago" },
  day3: { label: "3 Days Ago", desc: "3 days ago" },
  day5: { label: "5 Days Ago", desc: "5 days ago" },
  day7: { label: "1 Week Ago", desc: "7 days ago" },
};
  ...
  for (const key of dayOrder) {
    ...
    card.innerHTML = `
      <div class="revision-card-header">
        <span class="revision-day-label">${meta.label}</span>
