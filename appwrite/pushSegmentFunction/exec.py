...
FUNCTION_ID = os.getenv("PUSHSEGMENTFUNCTION_ID", "")
API_KEY     = os.getenv("APPWRITE_API_KEY", "")
ENDPOINT    = os.getenv("APPWRITE_ENDPOINT", "https://sgp.cloud.appwrite.io/v1")


def invoke_push_segment(request_body: dict) -> dict:
    client = Client()
...
if __name__ == "__main__":
    ...
    result = invoke_push_segment({
        "segment": sample_segment,
        "topics": ["Smartphone Industry Growth", "Corporate Finance"],
    })
