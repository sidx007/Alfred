...
def invoke_revision_chunks(request_body: dict | None = None) -> dict:
    ...
    execution = Functions(client).create_execution(
        ...
        body=json.dumps(request_body or {}),
        xasync=False,
        method="POST",
    )
